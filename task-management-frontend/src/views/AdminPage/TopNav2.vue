        ...
        <div class="app-header__mobile-menu">
          <div>
            <div class="mobileFlex" >
             ...
             <v-icon  title="Dashboard"  v-if="windowpath()!=='/dashboard'">mdi-view-dashboard</v-icon></router-link>
                    <a
                    ...
                    <div class="dropdown-menu dropmenudiv " >
                      <addProject />
            ...
            <!-- notification bar -->
              ...
              <div >
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropmenudiv2 " style="top: 25% !important;">
